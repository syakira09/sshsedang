...
wget -O /usr/bin/add-l2tp https://raw.githubusercontent.com/SSHSEDANG4/sshsedang/main/kebu/add-l2tp.sh && sed -i -e 's/\r$//' add-l2tp && chmod +x /usr/bin/add-l2tp
...
wget -O /usr/bin/renew-pptp https://raw.githubusercontent.com/SSHSEDANG4/sshsedang/main/kebu/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
