...
echo -e   " $mg ║\e[m$bd 13$bl]\e[m$bd Autobackup Data VPS [CLOSED]"
echo -e   " $mg ║\e[m$bd 14$bl]\e[m$bd Backup Data VPS [CLOSED]"
echo -e   " $mg ║\e[m$bd 15$bl]\e[m$bd Restore Data VPS [CLOSED]"
